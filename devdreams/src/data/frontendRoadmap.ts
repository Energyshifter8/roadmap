...
export const frontendSections: RoadmapSection[] = [
  ...
  },
  {
    ...
    left: [
      ...
      rd('solidjs', 'solidjs', 'optional', 'framework',
        'Reactive UI library with fine-grained reactivity.', 'left'),
    ],
    right: [
      rd('ai-dev', 'ai-dev', 'note', 'framework', undefined, 'right'),
    ],
  },
  {
    ...
    right: [
      rd('ai-basics', 'ai-basics', 'topic', 'ai-coding',
  ...
  },
  {
    ...
    left: [],
    right: [
      rd('tailwind2', 'tailwind2', 'recommended', 'writing-css',
  ...
  },
  {
    ...
    left: [
      rd('nextjs', 'nextjs', 'recommended', 'ssr',
